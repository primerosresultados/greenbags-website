-- ============================================================
-- CLIENTE: GreenBags — force-apply del rediseño de "Sobre GreenBags"
-- ============================================================
-- Re-aplica el rediseño de la migración 030 SIN el filtro defensivo
-- (`AND body LIKE '%<h2>Quiénes somos</h2>%'`) que pudo haber dejado
-- sin actualizar algunas instalaciones cuyo body original ya estaba
-- normalizado/editado y no calzaba con esa heurística.
--
-- Es idempotente: si 030 ya aplicó la nueva HTML, esta migración
-- pisa el body con el mismo contenido (no-op funcional).
--
-- Si el cliente había editado la página desde admin entre 030 y 031,
-- el edit se pisa. Es un trade-off consciente para garantizar que el
-- rediseño se aplique sí o sí.
--
-- Al forkear el starter para otro cliente, borrar este archivo junto
-- con 028, 029, 030 (ver docs/FORK_NEW_CLIENT.md).
-- ============================================================
