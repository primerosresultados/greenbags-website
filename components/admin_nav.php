...
<aside class="admin-sidebar" id="admin-sidebar">
    ...
    <a class="admin-sidebar__link<?= $is('home_edit') ? ' admin-sidebar__link--active' : '' ?>" href="/admin/?view=home_edit">
        <svg class="admin-sidebar__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M3 11l9-8 9 8v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V11z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
        <span>Inicio</span>
    </a>
    ...
    <div class="admin-sidebar__section">Tienda</div>

    <?php if (function_exists('quotesEnabled') && quotesEnabled()): ?>
        <a class="admin-sidebar__link<?= $is('quotes') || $is('quote') ? ' admin-sidebar__link--active' : '' ?>" href="/admin/?view=quotes">
            <svg class="admin-sidebar__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="14" x2="15" y2="14"/><line x1="9" y1="18" x2="13" y2="18"/></svg>
            <span>Cotizaciones</span>
        </a>
    <?php endif; ?>

    <a class="admin-sidebar__link<?= $is('products') || $is('product') || $is('products_bulk') || $is('products_upload') ? ' admin-sidebar__link--active' : '' ?>" href="/admin/?view=products">
    ...
    <a class="admin-sidebar__link<?= $is('categories') || $is('category') ? ' admin-sidebar__link--active' : '' ?>" href="/admin/?view=categories">
        <svg class="admin-sidebar__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>
        <span>Categorías</span>
    </a>

    <a class="admin-sidebar__link<?= $is('banners') || $is('banner') ? ' admin-sidebar__link--active' : '' ?>" href="/admin/?view=banners">
        <svg class="admin-sidebar__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="6" width="20" height="12" rx="2"/><circle cx="8" cy="12" r="1.5"/><polyline points="22 16 16 11 4 18"/></svg>
        <span>Banners</span>
    </a>

    <a class="admin-sidebar__link<?= $is('clients') || $is('client') ? ' admin-sidebar__link--active' : '' ?>" href="/admin/?view=clients">
    ...
    <a class="admin-sidebar__link<?= $is('payments') ? ' admin-sidebar__link--active' : '' ?>" href="/admin/?view=payments">
        <svg class="admin-sidebar__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/><line x1="6" y1="15" x2="10" y2="15"/></svg>
        <span>Pagos</span>
    </a>
