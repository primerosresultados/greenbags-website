...
<form method="post">
    ...
    <div class="card">
        ...
        <p class="form__field" style="margin:0;">
            <label style="display:flex;align-items:center;gap:.5rem;">
                <input type="checkbox" name="exclude_from_menu" value="1" style="width:auto;" <?= !empty($page['exclude_from_menu']) ? 'checked' : '' ?>>
                <span>Ocultar del menú principal (útil para "Gracias", legales, etc.)</span>
            </label>
        </p>
    </div>
