...
<div class="sifck-modal" id="sif-modal" hidden>
    ...
    <div class="sifck-panel">
        ...
        <footer class="sifck-footer">
            <div class="sifck-selected" id="sif-selected">Haz click en una imagen para seleccionarla.</div>
...
(function(){
    ...
    function open(field){
        ...
        selectedEl.textContent = 'Haz click en una imagen para seleccionarla.';
